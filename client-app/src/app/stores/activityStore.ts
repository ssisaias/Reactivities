...
export default class ActivityStore {
    ...
    updateActivity = async (activity: ActivityFormValues) => {
        try {
            ...
            runInAction(()=> {
                if(activity.id) {
                    let updatedAct = {...this.getActivity(activity.id), ...activity}
                    this.activityRegistry.set(activity.id, updatedAct as Activity);
                    this.selectedActivity = updatedAct as Activity;
                }
            })
        } catch (error) {
            console.log(error);
